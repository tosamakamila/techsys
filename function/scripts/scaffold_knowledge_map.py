...
用法：
    python function/scripts/scaffold_knowledge_map.py courses/<课程名>
    python function/scripts/scaffold_knowledge_map.py courses/<课程名> --dry-run  # 只预览不写文件
    python function/scripts/scaffold_knowledge_map.py courses/<课程名> --chapter 2  # 只生成指定章节
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print("      python function/scripts/scaffold_knowledge_map.py courses/<课程名> --dry-run")
        print("      python function/scripts/scaffold_knowledge_map.py courses/<课程名> --chapter 2")
        sys.exit(1)
