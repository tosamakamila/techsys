...
用法：
    ...
    python scripts/after_class.py courses/<课程名> --fragment L002a --status 已上课 --next L002b

    # 复习课修复（不推进位置）
    python scripts/after_class.py courses/<课程名> --fragment L001 --status 已上课 --review

    # 标记需复习
    python scripts/after_class.py courses/<课程名> --fragment L003 --status 需复习 --tag "反馈调节混淆"

    # 只更新知识地图（不更新 reading_plan）
    python scripts/after_class.py courses/<课程名> --km-only
"""
